                        ...
                        <div class="col-12 col-sm-4 col-md-3 col-lg-3  text-center">
                          <div class="panel panel-success ">
                            <div class="panel-heading " style="text-align: center;">
                                ...
                                <h4 align="center">{{ $service->serviceName }}</h4>
                                <a class="btn btn-xs btn-primary text-center" href="{{ route('services.prosthesis.show',[$service->id]) }}">
                                    <i class="fa fa-eye"> Show more</i>
                                </a>
                            </div>
                        </div>
                                ...
                                <div class="col-12 col-sm-4 col-md-3 col-lg-3 text-center">
                                    <div class="panel panel-success ">
                                      <div class="panel-heading " style="text-align: center;">
                                          <p style="text-align:center;">  <img class="imgdis" id={{ $service->id }} onclick="displayIMG(this.id)"  src="\image\service\item\{{ $service->pic }}" alt="Snow" style="height:200px;width:150px;max-width:200px"></p>
                                          <h4 align="center">{{ $service->serviceName }}</h4>
                                          <a class="btn btn-xs btn-primary text-center" href="{{ route('services.cosmetic.show',[$service->id]) }}">
                                              <i class="fa fa-eye"> Show more</i>
                                          </a>
                                      </div>
                                  </div>
                                          ...
                                          <div class="col-12 col-sm-4 col-md-3 col-lg-3 text-center">
                                              <div class="panel panel-success ">
                                                <div class="panel-heading " style="text-align: center;">
                                                    <p style="text-align:center;">  <img class="imgdis" id={{ $service->id }} onclick="displayIMG(this.id)"  src="\image\service\item\{{ $service->pic }}" alt="Snow" style="height:200px;width:150px;max-width:200px"></p>
                                                    <h4 align="center">{{ $service->serviceName }}</h4>
                                                    <a class="btn btn-xs btn-primary text-center" href="{{ route('services.children.show',[$service->id]) }}">
                                                      <i class="fa fa-eye"> Show more</i>
                                                  </a>
                                                </div>
                                            </div>
