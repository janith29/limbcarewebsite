...
<div class="container">
        ...
        <div class="container">
            ...
            <div class="col-12 panel panel-primary">
                ...
                <div class="panel-heading"><p style="text-align:center;"> <img src="/img/icons/orthosis.png" width="75px" height="75px"></p><h4 align="center">{{$types}}</h4>
             
                  <a  class="text-center" href="{{ route('services') }}">
                      <button type="button" class="btn btn-danger">Services home</button>
                    </a>
                </div>
              @endif
              @if (($types)==="Prosthesis care")
              <div class="panel-heading"><p style="text-align:center;"> <img src="/img/icons/pedestrian-walking.png" width="75px" height="75px"></p><h4 align="center">{{$types}}</h4>
            ...
            <div class="panel-heading"><p style="text-align:center;"> <img src="/img/icons/nose.png" width="75px" height="75px"></p><h4 align="center">{{$types}}</h4>
          ...
          <div class="panel-heading"><p style="text-align:center;"> <img src="/img/icons/chaild.png" width="75px" height="75px"></p><h4 align="center">{{$types}}</h4>
              ...
              <div class="col-12 col-sm-4 col-md-3 col-lg-3 text-center">
                <div class="panel panel-success ">
                    <div class="panel-heading " style="text-align: center;">
                        ...
                        <h4 align="center">{{ $service->serviceName }}</h4>
                        <a class="btn btn-xs btn-primary text-center" href="{{ route('services.orthosis.show',[$service->id]) }}">
                          <i class="fa fa-eye"> Show more</i>
                      </a>
                    </div>
                </div>
              </div>
