...
@section('content')
    <div class="row title-section">
        ...
        <div class="col-12 col-md-12">
            <a href="{{ route('admin.financial.IncomeReport') }}" class="btn btn-success">Income Report</a>
            <a href="{{ route('admin.financial.OutcomeReport') }}" class="btn btn-primary">Outcome Report</a>
    ...
    <div class="col-12">
            <div class="row">
                        <div class="col-xs-5 col-sm-6 col-lg-4" style="padding-top: 90px;">
                            <center> <div class="card" style="width: 18rem;">
                            <img class="card-img-top" src="\image\finacial\bill.png" alt="Card image cap" height="150" width="150">
                            <center>  <a href="{{ route('admin.financial.index_bill')}}" class="btn btn-primary" >Bill payment </a></center>
                          </div>
                        </div>
                        <div class="col-xs-5 col-sm-6 col-lg-4" style="padding-top: 90px;">
                            <center> <div class="card" style="width: 18rem;">
                            <img class="card-img-top" src="\image\finacial\payement.png" alt="Card image cap" height="150" width="150">
                            <center>  <a href="{{ route('admin.financial.index_salary')}}" class="btn btn-primary" >Salary payment </a></center>
                            </div></center>
                        </div>
                        <div class="col-xs-5 col-sm-6 col-lg-4" style="padding-top: 90px;">
                            <center> <div class="card" style="width: 18rem;">
                            <img class="card-img-top" src="\image\finacial\otherpayment.png" alt="Card image cap" height="150" width="150">
